...
public class D4Puzzle2 {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = Files.newBufferedReader(Paths.get("input.txt"))) {
            ...
            int removed;
            do {
                removed = accessibleRolls(map);
                finalSolution += removed;
            } while (removed > 0);
    ...
    /**
     * This method returns the number of rolls of paper with fewer than four rolls
